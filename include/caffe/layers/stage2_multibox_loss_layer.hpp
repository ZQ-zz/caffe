#ifndef CAFFE_STAGE2_MULTIBOX_LOSS_LAYER_HPP_
#define CAFFE_STAGE2_MULTIBOX_LOSS_LAYER_HPP_
...
class Stage2_MultiBoxLossLayer : public LossLayer<Dtype> {
 public:
  explicit Stage2_MultiBoxLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "Stage2_MultiBoxLoss"; }
...
#endif  // CAFFE_STAGE2_MULTIBOX_LOSS_LAYER_HPP_
